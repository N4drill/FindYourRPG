...
import pl.student.pwr.gluszczak.pawel.findyourrpg.Adapters.PastParticipatedAdapter;
...
public class PastGamesUserParticipatedFragment extends BaseFragmentCreator {

    private static final String TAG = "PastGamesUserPart";
    ...
    //Vars
    private PastParticipatedAdapter mPastParticipatedAdapter;
    ...
    private void updateAdapter() {
        ...
        mPastParticipatedAdapter = new PastParticipatedAdapter(mEvents, getActivity());
        mRecyclerView.setAdapter(mPastParticipatedAdapter);
    }
