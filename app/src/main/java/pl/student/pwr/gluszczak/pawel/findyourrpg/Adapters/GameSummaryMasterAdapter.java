...
public class GameSummaryMasterAdapter extends RecyclerView.Adapter<GameSummaryMasterAdapter.ViewHolder> {

    private static final String TAG = "GameSummaryMaster";
    ...
    public GameSummaryMasterAdapter(Context context, Event event, TextView emptyText) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        ...
        GameSummaryMasterAdapter.ViewHolder viewHolder = new GameSummaryMasterAdapter.ViewHolder(view);
        return viewHolder;
    }
    ...
    private void updateGameMasterStats(FirebaseFirestore mDatabase) {
        ...
        mGameMasterRef.update(update).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                mEmptyText.setText(mContext.getString(R.string.vote_on_players));
